package com.kuro.hrwebapp.repository;
...
import com.kuro.hrwebapp.CustomProperties;
...
public class EmployeeProxy {
	...
	public Iterable<Employee> getEmployees() {
		String baseApiUrl = props.getApiUrl();              // Récupération de l'URL de l'API
		String getEmployeesUrl = baseApiUrl + "/employees"; // Ajout de l'endpoint.

		RestTemplate restTemplate = new RestTemplate();     // Instanciation du Rest
		ResponseEntity<Iterable<Employee>> response = restTemplate.exchange(
				getEmployeesUrl, HttpMethod.GET, null,
	...
	public Employee getEmployee(int id) {
		...
		ResponseEntity<Employee> response = restTemplate.exchange(
				getEmployeeUrl, HttpMethod.GET, null, Employee.class);
	...
	public Employee createEmployee(Employee e) {
		...
		ResponseEntity<Employee> response = restTemplate.exchange(
				createEmployeeUrl, HttpMethod.POST, request, Employee.class);
	...
	public Employee updateEmployee(Employee e) {
		...
		HttpEntity<Employee> request = new HttpEntity<Employee>(e);
		ResponseEntity<Employee> response = restTemplate.exchange(
				updateEmployeeUrl, HttpMethod.PUT, request, Employee.class);
	...
	public void deleteEmployee(int id) {
		...
		ResponseEntity<Void> response = restTemplate.exchange(
				deleteEmployeeUrl, HttpMethod.DELETE, null, Void.class);
